...
#include <memory>
#include "../appdesign_4/audioplayer.h"
...
QT_MOC_LITERAL(1, 12, 9), // "playAudio"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 8) // "filePath"

    },
    "AudioPlayer\0playAudio\0\0filePath"
};
...
void AudioPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->playAudio((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
