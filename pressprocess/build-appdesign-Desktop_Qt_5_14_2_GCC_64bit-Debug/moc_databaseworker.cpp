...
#include <memory>
#include "../appdesign_4/databaseworker.h"
...
QT_MOC_LITERAL(3, 25, 7) // "process"
    ...
    "DatabaseWorker\0finished\0\0process"
};
...
void DatabaseWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DatabaseWorker::finished)) {
                *result = 0;
                return;
            }
        }
