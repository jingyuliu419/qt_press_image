...
PlotWidget1::PlotWidget1(Ui::MainWindow *ui, QWidget *parent) : QWidget(parent), ui(ui) {}
...
//    int onumClass5=0;
    ...
    if (!processedBase64Image.isEmpty()) {
        ...
        if(point.y()>10000){
            QString resultText = onnxInfer(dst1);
...
//        // Perform inference
//        QString predictedClass = PlotWidget1::onnxInferMultiChannel(inferenceImages);
