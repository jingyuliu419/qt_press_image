...
//    qDebug() << "Signal-slot connection established.";
    ...
    // 点击按钮时调用 PressSensor 的 new_slot
    index=0;
    QPushButton *selectBtn = ui->pushButton1;  // 确保按钮名称与 UI 对象匹配
    connect(selectBtn, &QPushButton::clicked, pressSensor, &PressSensor::new_slot);
}
...
//    qDebug() << "updatePressureUI received data:" << pressureData;
...
//    qDebug() << "UI updated with new data.";
}
...
//    //打开.txt文件
//    auto file_path = QFileDialog::getOpenFileName(this, "Select a text file", "/home/ljy/Doc1/mycode/original_data", "Text Files (*.txt)");
