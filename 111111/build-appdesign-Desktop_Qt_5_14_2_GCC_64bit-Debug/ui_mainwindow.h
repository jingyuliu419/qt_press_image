...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget->setGeometry(QRect(130, 22, 1107, 1279));
        ...
        img_label_2 = new QTextEdit(widget);
        ...
        classtextEdit = new QTextEdit(widget);
        ...
        img_label_3 = new QTextEdit(widget);
        ...
        plotWidget1 = new QWidget(widget);
